              ...
              <Container maxW={"Full"} mt={12}>
                <Flex flexWrap="wrap" gridGap={6} justify="center">
                  <Card
                    ...
                    href={"#"}
                  />
                  <Stack spacing={6} justify="center" direction={["column", "column", "row"]}>
                    <Card
                      heading={"Hypothesis 1"}
                    ...
                    <Card
                      ...
                      icon={<Icon as={FcInfo} w={10} h={10} />}
                      description={
                        "The formation of the NTF-ELCAC triggered the red-tagging of the Makabayan bloc."
                      }
                      href={"#"}
                    />
                  </Stack>
